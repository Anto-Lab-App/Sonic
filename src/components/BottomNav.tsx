...
export function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  ...
  return (
    <motion.div 
      ...
      className="fixed bottom-8 left-1/2 -translate-x-1/2 flex items-center gap-3 z-50 w-max"
    >
      ...
      <motion.button 
        ...
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        className={`relative flex items-center justify-center w-[80px] h-[80px] bg-foreground/5 backdrop-blur-2xl rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.3)] border border-foreground/10 transition-colors duration-300 group overflow-hidden ${
